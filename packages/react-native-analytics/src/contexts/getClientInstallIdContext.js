 ...
 * again. This id will be stored with @react-native-async-storage/async-storage
 * by default.
 *
 * @param {Object} [options]              - Options object to configure the context function that will be returned.
 * @param {Object} [options.storage]      - The storage instance to use to store the clientInstallId. This instance must provide the methods setItem(key, value) and getItem(key) to work. By default will use AsyncStorage from '@react-native-async-storage/async-storage' package.
